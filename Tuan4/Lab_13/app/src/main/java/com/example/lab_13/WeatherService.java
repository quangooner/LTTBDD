...
public class WeatherService extends Service {
    ...
    public void onRebin(Intent intent){
        Log.i(LOG_TAG,"onRebin");
        super.onRebind(intent);
    }
    public boolean onUnbind(Intent intent){
        Log.i(LOG_TAG,"onUnbind0");
        return true;
    }
    ...
    public  String getWeatherToday(String location){
        ...
        //
        String[] weathers = new String[]{"Ranin","Hot","Cool","Warm","Snowy"};
        //gias trij ngau nhien tu 0-4
